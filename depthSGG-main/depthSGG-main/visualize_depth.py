...
def generate_hha(i,image_ids2):
    ...
    # 读取RGB和深度图像
    original_depth, scale = read_pfm(f"/data1/zhouxukun/SGG-CoRF-main/openpifpaf/data/output/{depth_image_name}")
    ...
    print(f"save hha image to /data1/zhouxukun/SGG-CoRF-main/openpifpaf/data/hha/{image_ids}")
    cv2.imwrite(f'/data1/zhouxukun/SGG-CoRF-main/openpifpaf/data/hha/{image_ids}.png', hha)
    # pbtr.update(1)
